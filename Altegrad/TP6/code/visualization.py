...
############## Task 4
# Visualizes the representations of the n nodes that appear most frequently in the generated walks
def visualize(model, n, n_dim):

    nodes = model.wv.index_to_key[:n]
    
    DeepWalk_embeddings = np.zeros((n, n_dim))
